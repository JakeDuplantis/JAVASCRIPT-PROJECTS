$(document).ready(function() {
    function shineLoop(){
        //the shineLoop funtion uses the chaining technique to
    ...
    //stets the delayed amount of time between each repeat
    ...
    $("#classicCars").on({
        ...
        //mouse enters the div area with #classicCars ID
        mouseenter: function() {
            $("#titleOne").show(1000);
            $("#titleTwo").show(1500);
        ...
        //Triggers the images to slide up and hide each title one after the other when'
        //the user's mouse leaves the div area with the classicCars ID
        mouseleave: function() {
            $("#titleOne").hide(2000);
            $("#titleTwo").hide(1500);
    ...
    //creates a toggle effect on each FAQ question by checking each element's sibling so they 
    //don't all displaywhen one question is clicked
