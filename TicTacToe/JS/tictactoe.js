//This variable keeps track of whose turn it is. placeXOro
let activePlayer = 'X';
...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        //This condition checks to seee if it is the computers turn.
        if (activePlayer === 'O') {
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    let x1 = coordX1,
        //This indicates where the start of a line y axis is.
        y1 = coordY1,
    ...
    function animateLineDrawing() {
        ...
        c.lineWidth = 10;
        //This method sets teh color of our line.
        c.strokeStyle = 'rgba(70, 255, 33, .8)';
        //This method draws everything we laid out above.
        c.stroke();
        //This condition checks if we've reached the endpoints.
        if (x1 <= x2 && y1 <= y2) {
            //This conditon adds 10 to the previous end x endpoints.
            if (x < x2) { x += 10; }
            //This condition adds 10 to the previous end y endpoints.
            if (y < y2) { y +=10; }
